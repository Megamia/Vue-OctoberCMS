        ...
        <div class="fixed inset-0 z-40 flex">
          ...
          >
            ...
            >
              ...
              <div class="space-y-6 border-t border-gray-200 px-4 py-6">
                <div class="flow-root">
                  <a href="/Login" class="-m-2 block p-2 font-medium text-gray-900"
                    >Sign in</a
                  >
                </div>
                <div class="flow-root">
                  <a href="RegisterPage" class="-m-2 block p-2 font-medium text-gray-900"
                    >Create account</a
                  >
                </div>
              </div>
          ...
          <div class="flex h-16 items-center">
            ...
            <div class="ml-auto flex items-center">
              ...
              <div class="ml-4 flow-root lg:ml-6">
                <span class="group -m-2 flex items-center p-2" @click="handleOpenCart">
                  <ShoppingBagIcon
              ...
              <ShoppingCart v-if="isOpenCart" @close-cart="handleOpenCart" />
            </div>
          </div>
        </div>
      </nav>
      ...
      sections: [
        {
          ...
          items: [
            ...
            { name: "Jackets", href: "#" },
            { name: "Activewear", href: "#" },
            { name: "Browse All", href: "/ProductOverviews" },
          ],
        },
        {
          id: "accessories",
